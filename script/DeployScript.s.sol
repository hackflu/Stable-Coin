...
contract DeployDSC is Script {
    ...
    function run() external returns (DecentralizedStableCoin, DSCEngine, HelperConfig) {
        ...
        (DecentralizedStableCoin dsc, DSCEngine engine) =
            deployer(msg.sender, tokenAddresses, priceFeedAddresses, deployerKey);
    ...
    function deployer(
        ...
        uint256 deployerKey
    ) public returns (DecentralizedStableCoin, DSCEngine) {
        vm.startBroadcast();
